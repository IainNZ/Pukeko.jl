...
"""
function test_true(value, llinfo::Union{Nothing, LineNumberNode}=nothing)
    if value != true
...
"""
function test_equal(value_left, value_right, linfo::Union{Nothing, LineNumberNode}=nothing)
